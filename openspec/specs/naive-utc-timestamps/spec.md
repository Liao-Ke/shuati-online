...
All DateTime column defaults in the project use naive (timezone-unaware) UTC timestamps generated from Python, avoiding the deprecated `datetime.datetime.utcnow()` and ensuring consistency across models and business logic.
