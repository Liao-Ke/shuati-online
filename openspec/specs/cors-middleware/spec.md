...
Control cross-origin resource sharing (CORS) for the SPA frontend, allowing controlled access from configured origins while supporting credential-based auth.
